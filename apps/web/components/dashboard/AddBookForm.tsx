                                        ...
                                        <div className="space-y-2">
                                                ...
                                                <div className="space-y-2 max-h-60 overflow-y-auto p-3 border border-border rounded-lg bg-muted">
                                                        {categories.map((category) => (
                                                                <div
                                                                        key={category.id}
                                                                        className={`flex items-center space-x-3 p-2 rounded transition-colors cursor-pointer ${formData.primaryCategoryId === category.id
                                                                ...
                                                                >
                                                                        ...
                                                                        <Label
                                                                                ...
                                                                                className={`font-normal cursor-pointer ${formData.primaryCategoryId === category.id ? 'text-secondary-foreground' : 'text-foreground'
                                                                                        }`}
                                                                        >
                                                                                {category.name}
                                                                        </Label>
                                        ...
                                        <div className="space-y-2">
                                                ...
                                                <div className="space-y-2 max-h-60 overflow-y-auto p-3 border border-border rounded-lg bg-muted">
                                                        {categories.map((category) => (
                                                                <div
                                                                        key={category.id}
                                                                        className={`flex items-center space-x-3 p-2 rounded transition-colors cursor-pointer ${selectedCategories.includes(category.id)
                                                                                ? 'bg-secondary text-secondary-foreground'
                                                                                : 'hover:bg-accent'
                                                                                }`}
                                                                ...
                                                                >
                                                                        ...
                                                                        <Label
                                                                                ...
                                                                                className={`font-normal cursor-pointer ${selectedCategories.includes(category.id) ? 'text-secondary-foreground' : 'text-foreground'
                                                                                        }`}
                                                                        >
                                                                                {category.name}
                                                                        </Label>
                                        ...
                                        <div className="space-y-2">
                                                ...
                                                <div className="space-y-2 max-h-60 overflow-y-auto p-3 border border-border rounded-lg bg-muted">
                                                        {genres.map((genre) => (
                                                                <div
                                                                        key={genre.id}
                                                                        className={`flex items-center space-x-3 p-2 rounded transition-colors cursor-pointer ${selectedGenres.includes(genre.id)
                                                                                ? 'bg-secondary text-secondary-foreground'
                                                                                : 'hover:bg-accent'
                                                                                }`}
                                                                ...
                                                                >
                                                                        ...
                                                                        <Label
                                                                                ...
                                                                                className={`font-normal cursor-pointer ${selectedGenres.includes(genre.id) ? 'text-secondary-foreground' : 'text-foreground'
                                                                                        }`}
                                                                        >
                                                                                {genre.name}
                                                                        </Label>
