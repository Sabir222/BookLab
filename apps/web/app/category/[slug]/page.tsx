...
export default function CategoryPage({ params }: { params: { slug: string } }) {
  ...
  const categoryName = slugToCategoryMap[categorySlug] || "Category";
  ...
  useEffect(() => {
    // Reset selected categories to only include the current category when URL changes
  ...
  // Handle category selection (but always keep the current category selected)
